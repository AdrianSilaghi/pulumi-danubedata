...
func NewSshKey(ctx *pulumi.Context,
	...
	var resource SshKey
	err := ctx.RegisterResource("danubedata:index/sshKey:SshKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSshKey(ctx *pulumi.Context,
	...
	var resource SshKey
	err := ctx.ReadResource("danubedata:index/sshKey:SshKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
