...
namespace DanubeData.DanubeData
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/AdrianSilaghi/pulumi-danubedata";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("DanubeData.DanubeData.version.txt");
    ...
    internal sealed class DanubeDataResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public DanubeDataResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
